...
const ROLE_OPTIONS: { id: UserRole; label: string; desc: string; icon: React.ReactNode; color: string }[] = [
  ...
  { id: 'oceanographer', label: 'Oceanographer', desc: 'SST rasters, Argo profiles & evidence analysis', icon: <Cpu size={16} />, color: 'text-cyan-400 border-cyan-500/40 bg-cyan-500/10' },
...
=======
        ...
        <div className="mt-8 text-center">
          <p className="text-[10px] text-slate-600 uppercase tracking-widest tech-mono">
            ENCRYPTED BY ISRO SATELLITE INTELLIGENCE NETWORK
>>>>>>> frontend-changes
          </p>
        </div>
      </div>
