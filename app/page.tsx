...
export default function PremiumLandingPage() {
  ...
  return (
    <div className="w-full flex flex-col overflow-x-hidden min-h-screen font-sans bg-[#01050e]">
      
      {/* ================= TOP HALF (Orca & Turtle) ================= */}
      <div 
      ...
      >
        <div className="absolute inset-0 bg-[#010613]/20"></div> {/* Subtle darkening overlay for text readability */}
      ...
      <div className="w-full bg-[#01050e] relative z-20 border-y border-cyan-900/30 shadow-[0_0_50px_rgba(0,0,0,0.8)]">
        {/* 3. Features Section */}
      ...
      {/* ================= BOTTOM HALF (Whale & Seabed) ================= */}
      <div 
        className="w-full relative"
        style={{
          backgroundImage: 'url(/full-bg.png)',
          backgroundSize: 'cover',
          backgroundPosition: 'bottom center', // Anchors to the bottom of the image for the seabed
          backgroundRepeat: 'no-repeat',
        }}
      >
        <div className="absolute inset-0 bg-[#010613]/30"></div> {/* Subtle darkening overlay */}
        ...
        <div className="relative z-10 w-full">
          ...
          <section className="w-full min-h-[90vh] py-24 px-16 md:px-32 lg:px-48 flex items-center">
            <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row gap-20 items-center justify-between">
              ...
              <div className="lg:w-1/2">
                ...
                <div className="grid grid-cols-2 gap-y-12 gap-x-8 bg-[#010613]/40 backdrop-blur-md p-8 rounded-2xl border border-cyan-900/30">
          ...
          <section className="w-full pt-32 pb-16 px-8 flex flex-col items-center justify-center text-center">
             <div className="relative z-10 max-w-xl bg-[#010613]/50 backdrop-blur-lg p-12 rounded-3xl border border-cyan-900/30 shadow-[0_10px_50px_rgba(0,0,0,0.5)]">
